...
import { Box, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography, IconButton, Tooltip, TextField, Select, MenuItem, InputLabel, FormControl } from "@mui/material";
...
const isMobile = useMediaQuery(theme.breakpoints.down('sm'));
  ...
  return (
    <Box sx={{ padding: 3, margin: 0, backgroundColor: "#ffffff", minHeight: "100vh", color: "black" }}> {/* Changed colors */}
      <Typography variant="h4" sx={{ marginBottom: 2, fontWeight: "bold", textAlign: "center", color: "#000000" }}> {/* Changed color */}
        Game List
      </Typography>
      ...
      <Box sx={{ display: "flex", gap: 2, marginBottom: 2 }}>
        ...
        <FormControl sx={{ minWidth: 150, background: "#eaeaea", borderRadius: "5px" }}> {/* Changed colors */}
          <InputLabel sx={{ color: "#000000" }}>Category</InputLabel> {/* Changed color */}
          <Select value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)} sx={{ color: "black" }}> {/* Changed colors */}
